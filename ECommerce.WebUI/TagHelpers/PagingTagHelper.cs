    ...
    public class PagingTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (PageCount > 1)
            {
                ...
                if (CurrentPage > 1)
                {
                    sb.Append($"<li class='page-item'><a class='page-link' href='/product/index?page={CurrentPage - 1}&category={CurrentCategory}'>Previos</a></li>");
                }
                ...
                {
                    sb.Append($"<li class='page-item'><a class='page-link' href='/product/index?page={CurrentPage + 1}&category={CurrentCategory}'>Next</a></li>");
                }
